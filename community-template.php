...
<div class="wrapper p-0" id="page-wrapper">
    ...
    <div class="container-fluid py-4 site--content position-relative gap-3 d-flex justify-content-center flex-wrap">
        ...
        <a href="<?php echo site_url( ); ?>/#ContactUs" class="btn btn-primary py-3 px-4">Request a free
            consultation</a>
    </div>
                    ...
                    <div class="col-lg-8 col-md-12">
                        ...
                        <div class="event-section">
                            ...
                            <div class="event">
                                ...
                                <?php if( $r->event_description) { ?><p><?php echo $r->event_description; ?></p>
                                <?php } ?>
                                <?php if( $r->event_image) { ?><img
                                    src="<?php  echo get_field('event_image', $r->ID); ?>"
                                    style="width: 450px; height: auto;" /><?php } ?>
                                <?php if( $r->event_link) { ?><a href="<?php echo $r->event_link; ?>">
                                    <p>Learn More</p>
                                </a><?php } ?>
                            </div>
                            <?php endforeach; ?>
